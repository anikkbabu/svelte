...
// (181:4) <RouterContextProvider route={page.props.f7route} router={page.props.f7router}>
function create_default_slot(ctx) {
	let switch_instance;
	let t;
	let current;
	const switch_instance_spread_levels = [/*page*/ ctx[28].props];
	var switch_value = /*page*/ ctx[28].component;
	...
	return {
		...
		p(ctx, dirty) {
			...
			? get_spread_update(switch_instance_spread_levels, [get_spread_object(/*page*/ ctx[28].props)])
			: {};

			if (switch_value !== (switch_value = /*page*/ ctx[28].component)) {
				if (switch_instance) {
					group_outros();
...
// (180:2) {#each pages as page (page.id)}
function create_each_block(key_1, ctx) {
	...
	routercontextprovider = new RouterContextProvider({
			props: {
				route: /*page*/ ctx[28].props.f7route,
				router: /*page*/ ctx[28].props.f7router,
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*pages*/ 8) routercontextprovider_changes.route = /*page*/ ctx[28].props.f7route;
			if (dirty & /*pages*/ 8) routercontextprovider_changes.router = /*page*/ ctx[28].props.f7router;

			if (dirty & /*$$scope, pages*/ 2056) {
...
function create_fragment(ctx) {
	...
	const get_key = ctx => /*page*/ ctx[28].id;
