    ...
    function create_else_block_1$1(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(input_1, "focus", /*handleFocus*/ ctx[31]),
    					listen(input_1, "input", /*input_1_input_handler_1*/ ctx[63])
    				];
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(input_1, "focus", /*handleFocus*/ ctx[31]),
    					listen(input_1, "input", /*input_1_input_handler*/ ctx[61])
    				];
    ...
    function create_if_block_4(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(div, "focus", /*handleFocus*/ ctx[31]);
    				mounted = true;
    			}
    		},
    		p(ctx, dirty) {
    	...
    	return {
          ...
          l3.641,3.641L27.641,22.688L38.564,33.61L34.923,37.251z"></path></svg>`;
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(div, "click", prevent_default(/*handleClear*/ ctx[23]));
    				mounted = true;
    			}
    		},
    		p: noop,
    ...
    function create_fragment$5(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(window, "click", /*handleWindowClick*/ ctx[32]),
    					listen(window, "keydown", /*handleKeyDown*/ ctx[30]),
    					listen(window, "resize", /*getPosition*/ ctx[29]),
    					listen(div, "click", /*handleClick*/ ctx[33])
    				];
