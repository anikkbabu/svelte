(function (global, factory) {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen(div1, "mousedown", /*mousedown_handler_1*/ ctx[26]),
    					listen(div1, "mouseenter", /*mouseenter_handler_1*/ ctx[27]),
    					listen(div1, "mouseleave", /*mouseleave_handler_1*/ ctx[28])
    				];
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen(div2, "mousedown", /*mousedown_handler*/ ctx[23]),
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function progressBar(node) {
    		$$invalidate(31, progress_bar = node);
    	}
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*pointer, value, min, max*/ 3145985 | $$self.$$.dirty[1] & /*progress_bar*/ 1) {
    			 if (progress_bar && pointer) {
    				if (Array.isArray(value)) {
    					...
    					$$invalidate(31, progress_bar.style.width = `${per2 - per1}%`, progress_bar);
    					$$invalidate(31, progress_bar.style.left = `${per1}%`, progress_bar);
    				} else {
    					...
    					$$invalidate(31, progress_bar.style.width = `${per}%`, progress_bar);
    				}
    			}
    		}
