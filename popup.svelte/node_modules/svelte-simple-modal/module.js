import { createEventDispatcher, setContext, SvelteComponent as SvelteComponent$1 } from 'svelte';
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (default_slot && default_slot.p && dirty[1] & /*$$scope*/ 4096) {
				default_slot.p(get_slot_context(default_slot_template, ctx, /*$$scope*/ ctx[43], null), get_slot_changes(default_slot_template, /*$$scope*/ ctx[43], dirty, null));
			}
		},
		i(local) {
			if (current) return;
...
function instance($$self, $$props, $$invalidate) {
	...
	const SvelteComponent = SvelteComponent$1;
...
class Modal extends SvelteComponent {
	constructor(options) {
		super();
		if (!document_1.getElementById("svelte-fnsfcv-style")) add_css();
